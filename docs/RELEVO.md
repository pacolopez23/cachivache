...
**Estado hoy: 2454 pruebas en verde, analizador limpio, 50 puntos de la hoja
...
2. Ejecutar `tools/Probar.ps1` y confirmar **2454 en verde y analizador a cero**. Si no cuadra, eso es lo
